...
!!! note "Eclipse IDE Not Required"
    You do not have to use the Eclipse IDE to use the Lyo SDK. Although much of the documentation assumes you will be using Eclipse, the SDK is available as maven libraries, as detailed in [Setup an OSLC Provider/Consumer Application](setup.md).
