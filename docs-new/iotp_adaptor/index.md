...
[iotp-adaptor User Guide](./userGuide/user-guide.md) is a simple user's guide for installing, configuring, administering and using iotp-adapter with the CE tools.

[iotp-adaptor Developer Guide](./developer-guide.md) provides the complete documentation on how the server was developed.
