...
The OSLC4J Bugzilla adapter is a RESTful web application built on Java EE with [JAX-RS](https://jakarta.ee/learn/). It has the following additional dependencies:

+ [Eclipse Lyo](../../eclipse_lyo/eclipse-lyo.md) (formerly known as OSLC4J) is a Java toolkit that simplifies building OSLC applications
