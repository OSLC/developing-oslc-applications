...
We'll [put this dialog to use in the NinaCRM application later on](../integrating_with_an_oslc_provider/2_3_delegatedUI.md).
...
[Next: Part 1.7, Factory](1_7_factory.md)
