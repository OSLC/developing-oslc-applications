...
![An HTML page in a browser showing a list of Bugzilla bugs](http://archive.open-services.net/uploads/resources/collection-of-bugs-html.png)
...
That's useful on its own, but OSLC also specifies a capability called [OSLC Resource Preview](https://docs.oasis-open-projects.org/oslc-op/core/v3.0/os/resource-preview.html) (aka UI preview) for showing preview information about a resource in another tool. We'll tackle these rich preview formats in the next section.
