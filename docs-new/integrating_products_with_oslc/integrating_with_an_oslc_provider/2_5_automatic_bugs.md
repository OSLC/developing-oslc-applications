...
You can read more about [implementing Service Provider Catalogs for our Bugzilla Adapter here](../implementing_an_oslc_provider/1_2_providing_service_resources.md). In short, we represent every Bugzilla Product as a [Service Provider resource](http://archive.open-services.net/resources/tutorials/oslc-primer/serviceprovider), and we collect all of those Service Providers in one Service Provider Catalog. 
