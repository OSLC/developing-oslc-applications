...
Having done the [tutorials](./tutorials.md), if you'd like to explore some existing code, there are a variety of samples and existing applications available to be inspired from.

* [OSLC 2020 Reference Implementation](https://github.com/oslc-op/refimpl)
* The [iotp-adaptor](./iotp-adaptor-sample.md) is an OSLC adapter for IBM Watson IoT Platform. This sample provides a thourough user guide, as well as a developer guide covering many topics such as authentication, TRS, using [Lyo Designer](./eclipse_lyo/eclipse-lyo#lyo-designer), etc.
